...
export function FormMobPrimaryArmorLevel() {
  return (
    <div className="flex flex-col border border-stone-700 p-4 rounded-lg gap-4">
      <div className="text-white font-bold">Armor Level 0 - 1/1000</div>
...
export function FormMobSecondaryArmorLevel() {
  return (
    <div className="flex flex-col border border-stone-700 p-4 rounded-lg gap-4">
      <div className="text-white font-bold">Armor Level 1 - 1/2000</div>
      <div className="flex flex-col gap-2">
        <FormGroup className="px-4 py-2 flex-row rounded-lg border border-stone-700">
          <Input className="flex-auto" placeholder="0000 00 00 00 00 00 00" />
          <Label className="font-medium">Lactolerium</Label>
...
export function FormMobTertiaryArmorLevel() {
  return (
    <div className="flex flex-col border border-stone-700 p-4 rounded-lg gap-4">
      <div className="text-white font-bold">Armor Level 0 - 1/1000</div>
      <div className="flex flex-col gap-2">
...
export function FormMobQuartenaryArmorLevel() {
  return (
    <div className="flex flex-col border border-stone-700 p-4 rounded-lg gap-4">
      <div className="text-white font-bold">Armor Level 1 - 1/2000</div>
      <div className="flex flex-col gap-2">
